...
class ManualsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manual" do
    assert_difference('Manual.count') do
      post manuals_url, params: { manual: { author: @manual.author, comments: @manual.comments, file: @manual.file, title: @manual.title } }
    end
  ...
  test "should update manual" do
    patch manual_url(@manual), params: { manual: { author: @manual.author, comments: @manual.comments, file: @manual.file, title: @manual.title } }
